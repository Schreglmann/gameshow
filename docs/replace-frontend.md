...
| Method | Path | Purpose |
|--------|------|---------|
| `GET` | `/api/settings` | Global settings for the active gameshow (`showTitle` for the landing-page heading, point system incl. `pointMode`, rules, jokers, clean-install flag). |
