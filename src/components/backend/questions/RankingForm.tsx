...
function stripTrailingEmpty(answers: string[]): string[] {
  const next = [...answers];
...
export default function RankingForm({ questions, onChange, otherInstances, onMoveQuestion }: Props) {
  ...
  const updateAnswer = (qi: number, ai: number, value: string) => {
    ...
    answers[ai] = value;
    next[qi] = { ...next[qi], answers: stripTrailingEmpty(answers) };
    onChange(next);
  };
        ...
        >
          ...
          <div className="question-fields">
            <div className="full-width">
              ...
              <input className="be-input" value={q.question} placeholder="z.B. Top 5 umsatzstärkste Filme 2023 – in absteigender Reihenfolge" onChange={e => update(i, { question: e.target.value })} />
            </div>
            <div className="full-width">
