...
export default function AudioGuessInfo({ onGoToAssets }: Props) {
  return (
    <div className="backend-card" style={{ borderColor: 'rgba(102, 126, 234, 0.3)' }}>
      ...
      <p style={{ color: 'rgba(var(--text-rgb), max(0.7, var(--text-fade-floor, 0)))', lineHeight: 1.6 }}>
      ...
      <p style={{ color: 'rgba(var(--text-rgb), max(0.6, var(--text-fade-floor, 0)))', fontSize: 'var(--admin-sz-13, 13px)' }}>
