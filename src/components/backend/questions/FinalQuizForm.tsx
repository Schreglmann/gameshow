...
const isEmpty = (q: FinalQuizQuestion) =>
  !q.question.trim() && !q.answer.trim() && !q.answerImage;

export default function FinalQuizForm({ questions, onChange, otherInstances, onMoveQuestion }: Props) {
